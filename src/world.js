...
World.prototype.render = function(context) {
	...
	for(var i = 0; i<constants.STEPS; ++i) {
		...
		var red   = Math.floor(Math.sin(frequency*j + 0) * 127 + 128);
		var green = Math.floor(Math.sin(frequency*j + 2) * 127 + 128);
		var blue  = Math.floor(Math.sin(frequency*j + 4) * 127 + 128);
